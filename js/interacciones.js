...
sendButton.addEventListener("click", () => {
    ...
    const errorBody = document.getElementById("info-modal-body");
    errorBody.innerHTML = "";
    try{
        const res = function_dumplings(numberChickenDumplings, numberMeatDumplings, numberVeggiesDumplings);
        $("#info-Popup").modal("show");
        for (const [key, value] of Object.entries(res[1])) {
            let lineText = key + ' : ' + value.toString();
            errorBody.innerHTML += lineText;
            errorBody.appendChild(document.createElement("br"));
          }
          errorBody.innerHTML += "================================";
          errorBody.appendChild(document.createElement("br"));
          errorBody.innerHTML += "El precio por esta compra es de : " + res[0].toString();
...
const function_dumplings = (chickenDumplings, meatDumplings, veggieDumplings) => {
    // ========================================
